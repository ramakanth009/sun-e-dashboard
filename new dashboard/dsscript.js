document.addEventListener("DOMContentLoaded", function () {
  if(localStorage.getItem('username') !== 'iamdatascience'){
...
// function updateText(moduleNumber) {
//   const displayText = document.getElementById('progress');
//   displayText.textContent = `7% progress`;
// }
function updateText1() {
  const displayText = document.getElementById('progress3');
  displayText.textContent = `50% progress`;
...
function updateText2() {
  const displayText = document.getElementById('progress3');
  displayText.textContent = `100% progress`;
...
//   document.getElementById("watchVideosLink")?.addEventListener("click", function(event) {
...
// document.addEventListener("DOMContentLoaded", function () {
//   const videos = document.querySelectorAll('#coursevideo .video-element');
//   const progressElement = document.getElementById('progress3');
//   let watchedVideos = new Set(); // To keep track of unique videos watched
...
//       progressElement.textContent = `${progressPercentage}% - progress`;
//   }

//   // Event listener for each video
//   videos.forEach(video => {
//       video.addEventListener('ended', function () {
//           const videoContainer = video.closest('.video-container');
//           const videoId = videoContainer.getAttribute('data-video-id');
//           watchedVideos.add(videoId); // Add the video to the watched set
//           updateProgress(); // Update progress each time a video ends
//       });
//   });
...
//       // Ensure progress only calculated if there are videos
...
//   videos.forEach(video => {
//       video.addEventListener('ended', function () {
//           const videoContainer = video.closest('.vdbox');
//           const videoId = videoContainer.getAttribute('data-video-id');
//           watchedVideos.add(videoId); // Add the video to the watched set
//           updateProgress(); // Update progress each time a video ends
//       });
